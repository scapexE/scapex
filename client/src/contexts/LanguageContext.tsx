...
const translations: Record<string, Record<Language, string>> = {
  ...
  'nav.equipment': { en: 'Equipment Management', ar: 'إدارة المعدات' },
  'nav.hse': { en: 'HSE', ar: 'الصحة والسلامة والبيئة' },
  'nav.dms': { en: 'Document Management', ar: 'إدارة المستندات' },
  'nav.invoices': { en: 'Invoices & Contracts', ar: 'الفواتير والعقود' },
  ...
  'dash.overview': { en: 'System Overview', ar: 'نظرة عامة على النظام' },
